...
<div class="page people">
    <form method="POST" action="" enctype="multipart/form-data" id="fmBanneroid">
		...
		<fieldset id="kinds" style="width:500px;">
			...
			<label><input name="banner_kind" type="radio" value="kind_image" {if $_aRequest.banner_is_image}checked{/if} />{$aLang.banneroid_kind_image}</label>
