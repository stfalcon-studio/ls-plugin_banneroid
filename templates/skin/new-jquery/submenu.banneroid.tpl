<ul class="menu">
    <li {if $sEvent=='main' or $sEvent=='add'}class="active"{/if}>
        <div><a href="{router page='banneroid'}">{$aLang.banneroid_title}</a></div>
        {if $sEvent=='main' or $sEvent=='add'}
            <ul class="sub-menu">
                ...
                <li {if $sEvent=='add'}class="active"{/if}><div><a href="{router page='banneroid'}add/">{$aLang.banneroid_add}</a></div></li>
            </ul>
        {/if}
    </li>
